...
Start from the PR diff, then inspect complete changed files and any related code needed to understand behavior. Focus only on actionable correctness bugs, security vulnerabilities, regressions, broken edge cases, and important missing tests. Do not report style preferences, compliments, or speculative concerns without a concrete failure mode.
...
fs.writeFileSync(outputPath, `${JSON.stringify(structuredOutput)}\n`, { mode: 0o600 });
